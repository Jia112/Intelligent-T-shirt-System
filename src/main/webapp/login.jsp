    ...
    <div class="login_body">
        ...
        <div class="login_center">
            ...
            <div class="login_bg">
                ...
                <div class="forgotPwd">
                    <!--忘记密码-->
                    <a href="${pageContext.request.contextPath }/forgetPasswordServlet">忘记密码</a> 
                    <a href="${pageContext.request.contextPath }/forgetUsernameServlet">忘记用户名</a>
